                ...
                <header className={styles.footer}>
                   ...
                   <div className={styles.GetStartedButton}>
                    <div className={styles.OnboardingNavigation}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="194" height="40" viewBox="-135 0 194 40" fill="none">
                                <circle cx="138" cy="20" r="6" fill="#A2C1D1"/>
                                <circle cx="169" cy="20" r="6" fill="#A2C1D1"/>
                                <circle cx="199" cy="20" r="6" fill="#15243C"/>
                            </svg>
                            </div>
                    </div>
                   <Button
