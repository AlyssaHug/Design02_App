            ...
            <div className={styles.Page}>
                ...
                <header className={styles.footer}>
                    ...
                    <div className={styles.GetStartedButton}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="294" height="40" viewBox="0 0 194 40" fill="none">
                        ...
                        <button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="490" height="40" viewBox="0 0 20 40" fill="none">
