                ...
                <header className={styles.footer}>
                    ...
                    <div className={styles.GetStartedButton}>
                        <div className={styles.OnboardingNavigation}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="194" height="40" viewBox="-85 0 194 40" fill="none">
                            ...
                            > 
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="40" viewBox="-40 0 20 40" fill="none">
